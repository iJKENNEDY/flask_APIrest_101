...
class Customers(Resource):
    def get(self):
        ...
        query = conn.execute("select * from customers")  # Esta ejecuta un query y retorna un json como resultado
        return {'customers': [i[0] for i in query.cursor.fetchall()]}  #Se obtiene primera columna que es EmployeeId
